...
namespace smarthomeserver.Migrations
{
    ...
    [Migration("20230613075757_AddSmartDevices")]
    partial class AddSmartDevices
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("smart_home_server.Scenes.Models.SceneAction", b =>
                {
                    ...
                    b.Property<string>("SceneActionType")
                        .IsRequired()
                        .HasMaxLength(200)
                    ...
                    b.HasDiscriminator<string>("SceneActionType").HasValue("SceneAction");
            ...
            modelBuilder.Entity("smart_home_server.Scenes.Models.LightAction", b =>
                {
                    b.HasBaseType("smart_home_server.Scenes.Models.SceneAction");
                    ...
                    b.HasDiscriminator().HasValue("LightAction");
                });

            modelBuilder.Entity("smart_home_server.Scenes.Models.ShadeAction", b =>
                {
                    b.HasBaseType("smart_home_server.Scenes.Models.SceneAction");
                    ...
                    b.HasDiscriminator().HasValue("ShadeAction");
                });
            ...
            modelBuilder.Entity("smart_home_server.Scenes.Models.SceneAction", b =>
                {
                    b.HasOne("smart_home_server.Devices.Models.Device", "Device")
                        .WithMany()
